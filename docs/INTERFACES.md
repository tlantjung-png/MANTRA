...
The event bus contract allows subscription and unsubscription of handlers and fans out events synchronously while suppressing handler exceptions to isolate observers from the run and from each other.
